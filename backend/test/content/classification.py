...
if __name__ == "__main__":
    ...
    primary_thema_code = parse_thema_code_output(build_primary_thema_code(synopsis))
    ...
    secondary_thema_code = parse_thema_code_output(build_secondary_thema_code(synopsis, primary_thema_code))
